...
--bổ sung dữ liệu mới ngày 7/6/2025:

insert into import_reports (import_date, delivery_address, total_amount, employee_id, supplier_id) values 
('2025/04/28', '123 Ta Quang Buu', 2750000, 3, 13),
('2025/06/01', '124 Thanh Nhan', 4750000, 3, 12),
('2025/03/02', '123 Ta Quang Buu', 100900, 4, 15),
('2025/04/02', '124 Thanh Nhan', 2999996, 5, 22),
('2025/06/05', '123 Ta Quang Buu', 2999994, 6, 22);


insert into batch (import_date, expiration_date, total_quantity, quantity_in_stock, product_id, import_id, value_batch) values 
('2025/04/28', '2026/04/29', 100, 70, 13, 4, 1500000),
('2025/04/28', '2027/01/01', 150, 60, 14, 4, 1250000),
('2025/06/01', '2025/06/02', 200, 80, 6, 5, 1750000),
('2025/06/01', '2025/06/01', 50, 50, 7, 5, 2000000),
('2025/06/01', '2025/12/26', 150, 130, 12, 5, 2000000),
('2025/03/02', '2025/06/02', 300, 250, 10, 6,  100900),
('2025/04/02', '2025/12/30', 100, 50, 15, 7, 999998),
('2025/04/02', '2025/12/30', 100, 100, 15, 7, 999998),
('2025/04/02', '2025/12/31', 200, 40, 19, 7, 1000000),
('2025/06/05', '2026/04/04', 100, 100, 15, 8, 999998),
('2025/06/05', '2026/04/04', 100, 100, 15, 8, 999998),
('2025/06/05', '2026/04/04', 100, 100, 15, 8, 999998);
...
insert into salary (monthyear, basic_salary, workdays, allowance, note, adjustment, leave_pay, actual_salary, employee_id) values 
('5/2025', 200000, 30, 50000, 'Phep: 1', 0, 200000, 7700000, 3),
('5/2025', 200000, 31, 50000, 'Thuong NV chuyen can 100', 100000, 0, 7480000, 4),
('5/2025', 200000, 29, 50000, 'Muon: 1 Vang: 1', -250000, 0, 7700000, 6);

insert into check_reports (check_date) values 
('2025/05/05'),
('2025/05/31');

insert into check_details values 
(1, 1, 89),
(1, 18, 80),
(1, 19, 50),
(1, 20, 130),
