...
public class LoginController {
    ...
    public void initialize() {
        // Khai báo mật khẩu và role
        accountPassword.put("customer01", "123456"); accountRole.put("customer01", "customer");
        accountPassword.put("customer02", "123456"); accountRole.put("customer02", "customer");
        accountPassword.put("customer03", "123456"); accountRole.put("customer03", "customer");

        accountPassword.put("employee01", "abc123"); accountRole.put("employee01", "employee");
        accountPassword.put("employee02", "abc123"); accountRole.put("employee02", "employee");
        accountPassword.put("employee03", "abc123"); accountRole.put("employee03", "employee");

        accountPassword.put("admin01", "admin123");   accountRole.put("admin01",   "admin");
    }
    ...
    private void handleLogin() {
        ...
        try {
            ...
            if (role.equals("customer")) {
                ...
                controller.setAdmin(new Admin("AD001", "Quản lý siêu thị", "admin@gmail.com", "0123456789"));
                stage.setScene(new Scene(root));
