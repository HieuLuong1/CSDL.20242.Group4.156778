...
public class LoginController {
    ...
    public void initialize() {
        ...
        customerAccounts.put("customer01", new Customer("KH001", "Nguyen Van A", "nva@gmail.com", "0123456789"));

        accountPassword.put("employee01", "abc123");
        accountRole.put("employee01", "employee");
        employeeAccounts.put("employee01", new Employee("NV001", "Tran Thi B", "12/03/1998", "Nu", "tranb@gmail.com", "0987654321", "Ha Noi", "123456789012"));
    ...
    private void handleLogin() {
        ...
        try {
            if (role.equals("customer")) {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/hust/soict/hedspi/market/csdl_20242_oanhnt/User_MainLayout.fxml"));
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/hust/soict/hedspi/market/csdl_20242_oanhnt/Employee_MainLayout.fxml"));
                Parent root = loader.load();
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/hust/soict/hedspi/market/csdl_20242_oanhnt/Admin_MainLayout.fxml"));
                Parent root = loader.load();
